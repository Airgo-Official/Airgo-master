...
import io.github.ppoonk.airgo_master.repository.remote.model.ProtocolTemplateTableColumn
                    ...
                    item {
                        Column {
                            ...
                            Row(
                                ...
                                ProtocolTemplateTableColumn.entries.forEach { t ->
                                    Text(
                                            ...
                                            Row(
                                                ...
                                                SelectionContainer {
                                                    Text(
                                                        ...
                                                        modifier = Modifier.width(
                                                            ProtocolTemplateTableColumn.ID.width
                                                        )
                                                    )
                                                }
                                                ...
                                                SelectionContainer {
                                                    Text(
                                                        text = item.name,
                                                        modifier = Modifier.width(
                                                            ProtocolTemplateTableColumn.NAME.width
                                                        )
                                                    )
                                                }
                                                ...
                                                SelectionContainer {
                                                    Text(
                                                        ...
                                                        modifier = Modifier.width(
                                                            ProtocolTemplateTableColumn.CREATED_AT.width
                                                        )
                                                    )
                                                }
                                                Row(
                                                    ...
                                                    IconButton(onClick = {
                                                        sharedVM.nodeVM.initEditProtocolTemplate(
                                                            EditType.UPDATE,
                                                            item
                                                        )
                                                        navController.toEditProtocolTemplate()
                                                    ...
                                                    IconButton(onClick = {
                                                        sharedVM.dialogVM.openDialog(
                                                            ...
                                                            ACButtonError(onClick = {
                                                                scope.launch {
                                                                    Repository.remote.deleteProtocolTemplate(
                                                                        DeleteProtocolTemplateReq(id = item.id)
                                                                    )
                                                                        .onFailure { r ->
                                                                            sharedVM.dialogVM.openDialog(
